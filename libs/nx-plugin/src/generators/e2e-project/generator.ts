import { formatFiles, names, readProjectConfiguration, Tree, updateProjectConfiguration } from "@nrwl/devkit";
      ...
      e2e: {
        ...
        options: {
          commands: [
            ...
            {
              command: `PUBLISHED_VERSION=999.9.9-e2e.0 nx run-e2e-tests ${normalizedOptions.projectName}`,
            },
          ],
          parallel: false,
        },
